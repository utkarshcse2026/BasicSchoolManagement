...
firstw=Tk()
firstw.title("KENDRIYA VIDYALAYA KAMLA NEHRU NAGAR GZB")
firstw.geometry("1600x1000+0+0")
label=Label(text="KENDRIYA VIDYALAYA KAMLA NEHRU NAGAR GZB",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("KENDRIYA VIDYALAYA KAMLA NEHRU NAGAR GZB")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="KENDRIYA VIDYALAYA KAMLA NEHRU NAGAR GZB", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("KENDRIYA VIDYALAYA KAMLA NEHRU NAGAR GZB")
    global entry1
    global entry2
    global entry3
    global entry4
